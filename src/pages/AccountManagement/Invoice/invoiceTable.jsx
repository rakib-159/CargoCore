                ...
                <table className="min-w-full divide-y  divide-[#DFE1E6]">
                  <thead className=" text-[#414449] text-sm font-semibold tracking-[0.28px]">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="px-4 py-3.5  flex items-center justify-center rtl:text-right "
                      >
                        <button className="flex items-center  gap-x-1">
                    ...
                    {tData?.map((data, idx) => (
                      <tr key={idx}>
                        ...
                        <td className="px-4 py-4 text-center  whitespace-nowrap">
                          <button
                            className={`py-[2px] rounded-md px-4 ${
                              (data?.status === "Paid" && "bg-[#D4EDDA]") ||
                              (data?.status === "In Transit" &&
                                "bg-[#D0E3F6]") ||
                              (data?.status === "Delivered" &&
                                "bg-[#F8F4D2]") ||
                              (data?.status === "Pending" && "bg-[#F6EAD7]") ||
                              (data?.status === "Overdue" && "bg-[#F1D1D1]")
                            } `}
                          >
                            {data?.status}
                          </button>
